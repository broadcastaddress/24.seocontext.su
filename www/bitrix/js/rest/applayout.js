;(function(){
	...
	BX.rest.AppLayout.prototype = {
		init: function()
		{
			if(!this._inited)
			{
				...
				{
					window[this.params.frameName].src = document.forms[this.params.formName].action;
				}
				else
				{
		...
		selectUserCallback_0: function(v)
		{
			...
			{
				this.userSelectorControl[0].close();
		...
		selectUserCallback_1: function(v)
		{
			if(v === true)
			{
				...
				this.userSelectorControl[1].close();
	...
	BX.rest.AppLayout.MessageInterface.prototype = {
		...
		selectAccess: function(params, cb)
		{
			...
			{
				this.loadControl('access_selector', {}, BX.delegate(function()
				{
