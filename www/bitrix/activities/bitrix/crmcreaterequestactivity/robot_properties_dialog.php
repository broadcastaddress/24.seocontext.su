...
<?/*
	<div class="crm-automation-popup-checkbox-item">
		<label class="crm-automation-popup-chk-label">
			<input type="checkbox" name="<?=htmlspecialcharsbx($map['AutoComplete']['FieldName'])?>" value="Y" class="crm-automation-popup-chk"<?=$dialog->getCurrentValue($map['AutoComplete']['FieldName']) === 'Y' ? 'checked' : ''?>>
			<?=htmlspecialcharsbx($map['AutoComplete']['Name'])?>
		</label>
		<span class="crm-automation-status-help">?</span>
	</div>
*/?>
</div>