				...
				if ($this->pos <= $this->seek) // searching for function
				{
					if ($XRec->type == CXDRecord::TYPE_FUNC || $XRec->type == CXDRecord::TYPE_VAR)
					{
						...
						else
						{
							...
							if ($this->text_search_func && false === CBitrixXdebug::BinStrpos($XRec->text_func_name, $this->text_search_func) && false === CBitrixXdebug::BinStrpos($XRec->text_var_name, $this->text_search_func))
								continue;
