...
$MESS["SC_CHECK_TABLES_STRUCT_ERRORS"] = "Es gibt Fehler in der Datenbankstruktur (fehlende Tabellen: #NO_TABLES#, fehlende Felder: #NO_FIELDS#, abweichende Felder: #DIFF_FIELDS#, fehlende Indexe: #NO_INDEXES#). Gesamt Fehler: #VAL#. #VAL1# können sofort behoben werden.";
