...
$MESS["SC_HELP_CHECK_MAIL_PUSH"] = "Функція <a href=\"https://helpdesk.bitrix24.ru/open/1602367/\" target=_blank>публікації повідомлень</a> в живу стрічку з пошти дозволяє підключити до будь-якого обговорення чи завдання користувачів, які не мають облікового запису в вашому порталі.
...
$MESS["ERR_DNS"] = "Ви використовуєте Бітрікс веб-оточення старої версії, встановіть актуальну версію щоб не було проблем з налаштуванням сервера.";
