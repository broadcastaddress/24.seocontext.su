...
$MESS["main_app_pass_text2"] = "Cada uma destas ferramentas suportam uma gama de aplicativos que suportam sincronização. Selecione um aplicativo pelo qual você deseja configurar a transferência de dados.";
...
$MESS["main_app_pass_create_pass_text"] = "Use esta senha para sincronizar com o aplicativo selecionado.
	A senha pode não ser mantida na forma aberta; por isso, está disponível apenas quando obtida pelo usuário.
...
$MESS["main_app_pass_del_pass_text"] = "A sincronização será abortada porque o aplicativo será incapaz de acessar os dados devido a erro de autenticação.";
