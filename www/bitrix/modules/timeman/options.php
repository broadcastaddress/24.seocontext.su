...
<tr>
	<td valign="top" width="50%"><?=GetMessage("WR_PAGE_PATH")?>:</td><td valign="top" width="50%"><input name="WORK_REPORT_PATH" value="<?=$page_path;?>"></td>
</tr><tr>
	<td valign="top" width="50%"><?=GetMessage("TM_OPT_TIMEMAN_REPORT_PATH")?>:</td><td valign="top" width="50%"><input name="TIMEMAN_REPORT_PATH" value="<?=$timeman_page_path;?>"></td>
</tr>
<?
if (count($arHints) > 0):
?>
