...
$MESS["SALE_VK_MANUAL__CONNECTION_4"] = "Для з'єднання вашого Бітрікс-сайту з групою потрібно створити додаток ВКонтакті та отримати ключ доступу (access token).";
...
$MESS["SALE_VK_MANUAL__CONNECTION_5"] = "Створіть додаток, вибравши тип \"Веб-сайт\" і вказавши адресу та домен вашого сайту на Бітрікс. Перейдіть в «Налаштування» програми. ";
...
$MESS["SALE_VK_MANUAL__RUNNING_6"] = "Всі помилки під час експорту виводяться повідомленнями в адмінській частині. Так само відображається статистика минулих або поточного експорту.";
...
<i>Альбом може бути доданий та без зображення, але при його відсутності ви отримаєте повідомлення про помилку.</i>";
