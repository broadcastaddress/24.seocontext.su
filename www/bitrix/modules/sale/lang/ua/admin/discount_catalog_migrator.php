...
$MESS["DISCOUNT_CATALOG_MIGRATOR_NON_SUPPORTED_FEATURE_DISC_TYPE_SALE"] = "Дія знижки \"Встановити ціну товару\" ";
...
В залежності від кількості знижок на вашому проекті, процес об'єднання може зайняти тривалий час. Виконуйте перенесення в найменш навантажений для вашого магазину час.<br><br>
...
Перед початком об'єднання рекомендуємо зробити резервну копію вашого проекту і його бази даних.<br><br>
На час об'єднання ми відключимо публічну частину вашого проекту. ";
