                                        ...
                                        <script type="text/html" data-bx-id="user-item-set-item">
                                            <span data-bx-id="user-item-set-item" data-item-value="{{VALUE}}" class="task-inline-selector-item task-inline-selector-item-{{USER_TYPE}} {{ITEM_SET_INVISIBLE}}">
                                                <span class="task-options-destination task-options-destination-all-users">
	                                                <a href="<?=$userProfileUrlTemplate?>" target="_blank" class="task-options-destination-text">{{DISPLAY}}</a><span class="task-option-inp-del" data-bx-id="user-item-set-item-delete" title="<?=Loc::getMessage('TASKS_TASK_COMPONENT_TEMPLATE_DELETE')?>"></span>
                                                    <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[SE_RESPONSIBLE][{{VALUE}}][ID]" value="{{VALUE}}">
	                                                <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[SE_RESPONSIBLE][{{VALUE}}][EMAIL]" value="{{EMAIL}}">
	                                                <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[SE_RESPONSIBLE][{{VALUE}}][NAME]" value="{{NAME}}">
	                                                <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[SE_RESPONSIBLE][{{VALUE}}][LAST_NAME]" value="{{LAST_NAME}}">
                                                </span>
                                            </span>
                                        </script>
                                    </span>
                                        ...
                                        <script type="text/html" data-bx-id="user-item-set-item">
                                            <span data-bx-id="user-item-set-item" data-item-value="{{VALUE}}" class="task-inline-selector-item task-inline-selector-item-{{USER_TYPE}} {{ITEM_SET_INVISIBLE}}">
                                                <span class="task-options-destination task-options-destination-all-users">
	                                                ...
	                                                <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[<?=$blockName?>][ID]" value="{{VALUE}}" <?=$disabled?> />
	                                                <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[<?=$blockName?>][EMAIL]" value="{{EMAIL}}" <?=$disabled?> />
	                                                <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[<?=$blockName?>][NAME]" value="{{NAME}}" <?=$disabled?> />
	                                                <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[<?=$blockName?>][LAST_NAME]" value="{{LAST_NAME}}" <?=$disabled?> />
                                                </span>
                                            </span>
                                        </script>
                                    </span>
                                        ...
                                        <script type="text/html" data-bx-id="user-item-set-item">
                                            <span data-bx-id="user-item-set-item" data-item-value="{{VALUE}}" class="task-inline-selector-item task-inline-selector-item-{{USER_TYPE}} {{ITEM_SET_INVISIBLE}}">
                                                <span class="task-options-destination task-options-destination-all-users">
	                                                ...
	                                                <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[<?=$blockName?>][{{VALUE}}][EMAIL]" value="{{EMAIL}}">
	                                                <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[<?=$blockName?>][{{VALUE}}][NAME]" value="{{NAME}}">
	                                                <input type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[<?=$blockName?>][{{VALUE}}][LAST_NAME]" value="{{LAST_NAME}}">
                                                </span>
                                            </span>
                                        </script>
                                    </span>
                        ...
                        <div data-bx-id="task-edit-<?=$blockNameJs?>-block" data-block-name="<?=$blockName?>" class="pinable-block task-options-item task-options-item-<?=$blockNameJs?><?=$itemOpenClass?>">
                            ...
                            <?if($blockName == Manager\Task::SE_PREFIX.'PROJECT'):?>
                                ...
                                <span id="bx-component-scope-project-<?=$templateId?>" class="task-options-item-project group-item-set-empty-true">
	                                ...
	                                <input data-bx-id="task-edit-project-input" type="hidden" name="<?=htmlspecialcharsbx($inputPrefix)?>[<?=$blockName?>][ID]" value="">
                                        ...
                                        <span data-bx-id="group-item-set-items">
                                            <script type="text/html" data-bx-id="group-item-set-item">
                                                <span data-bx-id="group-item-set-item" data-item-value="{{VALUE}}" class="task-inline-selector-item {{ITEM_SET_INVISIBLE}}">
                                                    <span class="task-options-destination task-options-destination-all-users">
                                                        <a href="<?=str_replace('#group_id#', '{{VALUE}}', $arParams['PATH_TO_GROUP'])?>" target="_blank" class="task-options-destination-text">{{DISPLAY}}</a><span class="task-option-inp-del" data-bx-id="group-item-set-item-delete" title="<?=Loc::getMessage('TASKS_TASK_COMPONENT_TEMPLATE_DELETE')?>"></span>
                                                    </span>
                                                </span>
                                            </script>
                                        </span>
