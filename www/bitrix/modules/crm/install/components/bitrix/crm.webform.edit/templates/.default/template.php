...
<div class="crm-webform-edit-wrapper">
	...
	<div id="CSS_TEXT_CONTAINER" class="crm-webform-edit-task-options-item-open-settings <?=($arResult['FORM']['USE_CSS_TEXT'] ? '' : 'crm-webform-display-none')?>">
		<div class="crm-webform-edit-task-edit-sent-options-redirect-container">
			<div class="crm-webform-edit-task-edit-sent-redirect-checkbox-container">
				<div class="task-sent-redirect-checkbox-item-container">
					<span class="task-sent-redirect-checkbox-item"><?=Loc::getMessage('CRM_WEBFORM_EDIT_CSS_URL')?>:</span>
				</div>
			</div>
			...
			<div class="crm-webform-edit-task-edit-sent-options-redirect-container">
				<div class="crm-webform-edit-task-edit-sent-redirect-checkbox-container">
					...
					<label for="USE_RESULT_SUCCESS_URL" class="task-field-label task-field-label-repeat">
						<div class="task-sent-redirect-checkbox-item-container">
							<span class="task-sent-redirect-checkbox-item"><?=Loc::getMessage('CRM_WEBFORM_EDIT_RESULT_ACTIONS_SUCC_URL')?>:</span>
						</div>
					</label>
				</div>
			...
			<div class="crm-webform-edit-task-edit-sent-options-redirect-container">
				<div class="crm-webform-edit-task-edit-sent-redirect-checkbox-container">
					...
					<label for="USE_RESULT_FAILURE_URL" class="task-field-label task-field-label-repeat">
						<div class="task-sent-redirect-checkbox-item-container">
							<span class="task-sent-redirect-checkbox-item"><?=Loc::getMessage('CRM_WEBFORM_EDIT_RESULT_ACTIONS_ERR_URL')?>:</span>
						</div>
					</label>
				</div>
	...
	<div class="crm-webform-edit-task-options-metric-create">
		...
		<div id="RECAPTCHA_CUSTOM_CONTAINER" class="crm-webform-edit-task-options-item-open-settings <?=(($arResult['CAPTCHA']['HAS_OWN_KEY'] || !$arResult['CAPTCHA']['HAS_DEFAULT_KEY']) ? '' : 'crm-webform-display-none')?>">
			<div class="crm-webform-edit-task-edit-sent-options-redirect-container">
				<div class="crm-webform-edit-task-edit-sent-redirect-checkbox-container">
					<div class="task-sent-redirect-checkbox-item-container">
						<span class="task-sent-redirect-checkbox-item"><?=Loc::getMessage('CRM_WEBFORM_EDIT_CAPTCHA_KEY')?>:</span>
					</div>
				</div>
				<div class="crm-webform-edit-task-edit-deal-sent-redirect-input-container">
			...
			<div class="crm-webform-edit-task-edit-sent-options-redirect-container">
				<div class="crm-webform-edit-task-edit-sent-redirect-checkbox-container">
					<div class="task-sent-redirect-checkbox-item-container">
						<span class="task-sent-redirect-checkbox-item"><?=Loc::getMessage('CRM_WEBFORM_EDIT_CAPTCHA_SECRET')?>:</span>
					</div>
				</div>
				<div class="crm-webform-edit-task-edit-deal-sent-redirect-input-container">
				...
				<div class="crm-webform-edit-task-options-item crm-webform-edit-task-options-item-destination">
					...
					<div class="crm-webform-edit-task-options-item-open-inner">
						...
						$userSelectorParams = array(
							'EDITOR_ID' => 'crm_webform_edit_form_responsible',
							'NAME' => 'crm_webform_edit_form',
							'INPUT_NAME' => 'ASSIGNED_BY_NAME',
							...
							'SITE_ID' => SITE_ID,
							'USER' => array(
								'id' => $arResult['FORM']['ASSIGNED_BY_ID'],
								'name' => $arResult['FORM']['ASSIGNED_BY_NAME'],
							),
						);
						echo '<script type="text/javascript">',
						'BX.ready(function(){',
						'BX.CrmUserSearchPopup.deletePopup("', $userSelectorParams['EDITOR_ID'], '");',
						'BX.CrmUserSearchPopup.create("', $userSelectorParams['EDITOR_ID'], '", { searchInput: BX("', CUtil::JSEscape($userSelectorParams['INPUT_NAME']), '"), dataInput: BX("', CUtil::JSEscape($userSelectorParams['DATA_INPUT_NAME']),'"), componentName: "', CUtil::JSEscape($userSelectorParams['NAME']),'", user: ', CUtil::PhpToJSObject(array_change_key_case($userSelectorParams['USER'], CASE_LOWER)) ,', zIndex: ', 0,' }, ', 0,');',
						'}); </script>';
						...
						?>
						<div>
							<input value="<?=htmlspecialcharsbx($arResult['FORM']['ASSIGNED_BY_NAME'])?>" class="crm-webform-edit-task-edit-deal-sent-options-input" type="text" name="ASSIGNED_BY_NAME" id="ASSIGNED_BY_NAME" autocomplete="off">
							<input value="<?=htmlspecialcharsbx($arResult['FORM']['ASSIGNED_BY_ID'])?>" type="hidden" name="ASSIGNED_BY_ID" id="ASSIGNED_BY_ID">
						</div>
					</div>
				</div><!--crm-webform-edit-task-options-item crm-webform-edit-task-options-item-destination-->
			</div>
			<?
