...
$MESS["CRM_CH_TRACKER_HELP_POPUP_CONTENT"] = "<p>The report columns use different data inside a selected reporting period.</p><p>The \"Incoming/Outgoing control\" and \"Sales for time period\" columns use all data accumulated during the reporting period (month, year etc).</p><p>The \"Leads awaiting processing\" and \"Deals in progress\" columns use end-of-period data.</p><p>Example: if you select deals in progress for the last month, you will get all the deals that were being active on the last day of the month without respect to anything that might have occurred earlier.</p>";
?>