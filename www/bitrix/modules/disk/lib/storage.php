...
final class Storage extends Internals\Model
{
	...
	protected function initializeProxyType()
	{
		...
		{
			return $this->tryToCreateExtranetUser($proxyType);
		}

		return $proxyType;
	}

	private function tryToCreateExtranetUser(ProxyType\User $proxyTypeUser)
	{
		if($proxyTypeUser->getUser()->isExtranetUser())
		{
			return new ProxyType\ExtranetUser($this->entityId, $this, $this->entityMiscData);
		}
