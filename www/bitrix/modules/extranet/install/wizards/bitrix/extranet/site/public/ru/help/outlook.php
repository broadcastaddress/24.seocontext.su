...
<table border="0" cellspacing="1" cellpadding="1" width="100%">
  <tbody>
    <tr><td valign="top"><img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#my_kalendar" >синхронизация персональных календарей</a>;
        <br />
      <img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#company_calendar" >синхронизация календарей компании; </a>
        <br />
      <img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#useful" >синхронизация личных контактов</a>;
        <br />
      <img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#kalendars" >экспорт нескольких календарей; </a>
        <br />
      <img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#kalendars" >отображение календарей на одной сетке в MS Outlook.</a>
        <br />
      <img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#useful1" >синхронизация личных задач</a>;
        <br />
      </td><td>
        <br />
      </td><td valign="top">
...
<?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array(
	"AREA_FILE_SHOW" => "file",
	"PATH" => "#SITE_DIR#help/outlook_inc.php",
	"EDIT_TEMPLATE" => ""
	),
	false
);?>
...
<div align="center">
  ...
  <table style="BORDER-COLLAPSE: collapse" border="0" cellspacing="1" cellpadding="1">
    <tbody>
      <tr><td>
          <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/main.png', 1039, 705, 'Добавленные сотрудники')"><img title="Добавленные сотрудники" border="0" alt="Добавленные сотрудники" src="#SITE_DIR#images/docs/main_sm.png" width="500" height="339" /> </a>
            <br />
          </div>
...
<div align="center"><img border="0" src="#SITE_DIR#images/docs/go_to.png" width="302" height="244" />
  <br />
...
<div align="center"><img src="#SITE_DIR#images/docs/step1.png" width="482" height="202" />
  <br />
</div>
...
<div align="center">
  ...
  <table style="BORDER-COLLAPSE: collapse" border="0" cellspacing="1" cellpadding="1">
    <tbody>
      <tr><td>
          <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/step2.png', 518, 448, 'Описание календаря')"><img title="Описание календаря" border="0" alt="Описание календаря" src="#SITE_DIR#images/docs/step2_sm.png" width="299" height="259" /> </a>
            <br />
          </div>
...
<div align="center">
  ...
  <table style="BORDER-COLLAPSE: collapse" border="0" cellspacing="1" cellpadding="1">
    <tbody>
      <tr><td>
          <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/calendar1.png', 550, 434, 'Календарь добавился в Outlook!')"><img title="Календарь добавился в Outlook!" border="0" alt="Календарь добавился в Outlook!" src="#SITE_DIR#images/docs/calendar1_sm.png" width="300" height="237" /> </a>
            <br />
          </div>
...
<div align="center">
  <table style="BORDER-COLLAPSE: collapse" border="0" cellspacing="1" cellpadding="1">
    <tbody>
      <tr><td>
          <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/calendar2.png', 550, 434, 'Экспортированные календари в MS Outlook')"><img title="Экспортированные календари в MS Outlook" border="0" alt="Экспортированные календари в MS Outlook" src="#SITE_DIR#images/docs/calendar2_sm.png" width="300" height="237" /> </a>
            <br />
          </div>
...
<div align="center">
  <table cellspacing="1" cellpadding="1" border="0" style="border-collapse: collapse;"> 
    <tbody> 
      <tr><td> 
          <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/event.png', 600, 378, 'Экспортированные календари в MS Outlook')"><img width="300" height="189" border="0" src="#SITE_DIR#images/docs/event_sm.png" alt="Экспортированные календари в MS Outlook" title="Экспортированные календари в MS Outlook" /> </a> 
            <br />
           </div>
...
<p class="a1" align="center"><img src="#SITE_DIR#images/docs/status.png" width="370" height="26" /></p>
А вот то же самое событие <b>в календаре на сайте экстранета</b>!
<br />

<br />

<div align="center"><img src="#SITE_DIR#images/docs/event_portal.png" width="477" height="294" /></div>
...
<div align="center">
  <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/tasks.png', 700, 442, 'Синхронизация личных задач')"><img title="Синхронизация личных задач" border="0" alt="Синхронизация личных задач" src="#SITE_DIR#images/docs/tasks_sm.png" width="400" height="252" /> </a>
    <br />
  </div>
