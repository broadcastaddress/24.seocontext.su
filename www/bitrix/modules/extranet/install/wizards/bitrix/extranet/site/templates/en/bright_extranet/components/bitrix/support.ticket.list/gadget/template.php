...
if (array_key_exists("TICKETS", $arResult) && is_array($arResult["TICKETS"])):
	...
	foreach ($arResult["TICKETS"] as $arTicket):
		...
		<table class="support-ticket-lamp"><tr><td><div class="support-lamp-<?=str_replace("_","-",$arTicket["LAMP"])?>" title="<?=GetMessage("G_TICKETS_".strtoupper($arTicket["LAMP"])."_ALT")?>"></div></td><td><b><a href="<?=$arTicket["TICKET_EDIT_URL"]?>"><? echo $arTicket["TITLE"]; ?></a></b></td></tr></table>
