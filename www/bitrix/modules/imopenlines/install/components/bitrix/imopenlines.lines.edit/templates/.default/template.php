...
<script type="text/javascript">
	function imolOpenTrialPopup(dialogId)
	{
		B24.licenseInfoPopup.show(dialogId, "<?=CUtil::JSEscape(Loc::getMessage("IMOL_CONFIG_EDIT_POPUP_LIMITED_TITLE"))?>", "<?=CUtil::JSEscape(Loc::getMessage("IMOL_CONFIG_EDIT_POPUP_LIMITED_TEXT"))?>");
	}
</script>
				...
				<div class="tel-set-item-cont-block">
					...
					<div class="tel-set-item-cont">
						<div class="tel-set-item-text">
							...
							<div class="tel-lock-holder-select" title="<?=GetMessage("IMOL_CONFIG_LOCK_ALT")?>"><div onclick="imolOpenTrialPopup('imol_queue')" class="tel-lock tel-lock-half"></div></div>
							<?endif;?>
						</div>
						...
						<div class="tel-set-item-select-block" style=" margin-top: 35px">
							...
							<select class="tel-set-inp tel-set-item-select" name="CONFIG[QUEUE_TYPE]" id="QUEUE_TYPE">
									...
									<option value="all" <?if($arResult["CONFIG"]["QUEUE_TYPE"] == "all") { ?>selected<? }?>><?=Loc::getMessage("IMOL_CONFIG_EDIT_QUEUE_TYPE_ALL")?></option>
							</select>
				...
				<div class="tel-set-item-cont-block">
					...
					<div class="tel-set-item-cont">
						...
						<div class="tel-set-item-select-block tel-set-item-crm-rule" id="imol_no_answer_rule_text">
							...
							<textarea class="tel-set-inp tel-set-item-textarea" name="CONFIG[NO_ANSWER_TEXT]"><?=($arResult["CONFIG"]["NO_ANSWER_TEXT"])?></textarea>
						</div>
						<script type="text/javascript">
							BX.OpenLinesConfigEdit.toggleSelectFormText(
								BX('imol_no_answer_rule'),
				...
				<div class="tel-set-item-cont-block">
					...
					<div class="tel-set-item-cont tel-set-item-crm-rule" id="imol_worktime"<? if ($arResult['CONFIG']['WORKTIME_ENABLE'] == "Y") { ?>style="height: auto"<? } ?> >
						...
						<div class="tel-set-item-select-block tel-set-item-crm-rule" id="imol_worktime_dayoff_rule_text">
							...
							<textarea class="tel-set-inp tel-set-item-textarea" name="CONFIG[WORKTIME_DAYOFF_TEXT]"><?=$arResult["CONFIG"]["WORKTIME_DAYOFF_TEXT"]?></textarea>
						</div>
						<script type="text/javascript">
							BX.OpenLinesConfigEdit.toggleSelectFormText(
			...
			<div class="tel-set-item-cont-block">
				...
				<div class="tel-set-item-cont">
					<div class="tel-set-item-select-block tel-set-item-crm-rule" id="imol_action_welcome">
						...
						<textarea class="tel-set-inp tel-set-item-textarea" name="CONFIG[WELCOME_MESSAGE_TEXT]"><?=$arResult["CONFIG"]["WELCOME_MESSAGE_TEXT"]?></textarea>
					</div>
				</div>
			</div>
			<script type="text/javascript">
			...
			<div class="tel-set-item-cont-block">
				...
				<div class="tel-set-item-cont">
					...
					<div class="tel-set-item-select-block tel-set-item-crm-rule" id="imol_action_close_text">
						...
						<textarea class="tel-set-inp tel-set-item-textarea" name="CONFIG[CLOSE_TEXT]"><?=($arResult["CONFIG"]["CLOSE_TEXT"])?></textarea>
					</div>
					<script type="text/javascript">
			...
			<div class="tel-set-item-cont-block">
				...
				<div class="tel-set-item-cont">
					...
					<div class="tel-set-item-select-block tel-set-item-crm-rule" id="imol_action_auto_close_text">
						...
						<textarea class="tel-set-inp tel-set-item-textarea" name="CONFIG[AUTO_CLOSE_TEXT]"><?=($arResult["CONFIG"]["AUTO_CLOSE_TEXT"])?></textarea>
					</div>
					<script type="text/javascript">
						BX.OpenLinesConfigEdit.toggleSelectFormOrText(
