...
class CVoxImplantMain
{
	...
	public static function CallStart($callId, $userId, $callDevice = 'WEBRTC', $external = false)
	{
		...
		$res = Bitrix\Voximplant\CallTable::getList(Array(
			'select' => Array('ID', 'CALL_ID', 'CALLER_ID', 'DATE_CREATE', 'CRM_LEAD', 'PORTAL_USER_ID'),
	...
	public static function GetTrialText()
	{
		...
		$text = GetMessage('VI_TRIAL_TEXT_TITLE').'
			<ul class="hide-features-list">
				...
				<li class="hide-features-list-item">'.GetMessage('VI_TRIAL_FEATURES_6').' <sup class="hide-features-soon">'.GetMessage('VI_TRIAL_SOON').'</sup> <a href="'.GetMessage('VI_TRIAL_LINK').'" target="_blank" class="hide-features-more">'.GetMessage('VI_TRIAL_LINK_TEXT').'</a></li>
			</ul>
			<strong>
