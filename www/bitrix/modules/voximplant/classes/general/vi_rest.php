...
class CVoxImplantRestService extends IRestService
{
		...
		return array(
			'telephony' => array(
				...
				CRestUtil::EVENTS => array(
					...
					self::EVENT_START_EXTERNAL_CALL => array('voximplant', 'onExternalCallStart', array(__CLASS__, 'onExternalCallStart'))
				),
			),
			'call' => array(
	...
	public static function onExternalCallStart($arParams, $arHandler)
	{
