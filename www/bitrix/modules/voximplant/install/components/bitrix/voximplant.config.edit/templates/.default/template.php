				...
				<div class="tel-set-item-cont-block">
					...
					<div class="tel-set-item-cont">
						...
						<div class="tel-set-item-select-block">
							...
							<select class="tel-set-inp tel-set-item-select" name="QUEUE_TYPE" id="QUEUE_TYPE">
								<?foreach (array(CVoxImplantConfig::QUEUE_TYPE_EVENLY, CVoxImplantConfig::QUEUE_TYPE_STRICTLY, CVoxImplantConfig::QUEUE_TYPE_ALL) as $k):?>
									<option value="<?=$k?>"<?=($k == $arResult["ITEM"]["QUEUE_TYPE"] ? " selected" : "")?>><?=GetMessage("VI_CONFIG_EDIT_QUEUE_TYPE_".strtoupper($k))?></option>
								<?endforeach;?>
							</select>
						...
						<div id="vi_queue_time" class="tel-set-item-select-block tel-set-item-crm-rule" style="<?=($arResult["ITEM"]["QUEUE_TYPE"] == CVoxImplantConfig::QUEUE_TYPE_ALL? '': 'height: 55px')?>">
					...
					<div class="tel-set-item-cont">
						...
						<div class="tel-set-item-select-block">
							...
							<select class="tel-set-inp tel-set-item-select" name="NO_ANSWER_RULE" id="vi_no_answer_rule">
								...
								<?if(!in_array($arResult["ITEM"]["QUEUE_TYPE"], Array(CVoxImplantConfig::QUEUE_TYPE_STRICTLY, CVoxImplantConfig::QUEUE_TYPE_ALL))):?>
