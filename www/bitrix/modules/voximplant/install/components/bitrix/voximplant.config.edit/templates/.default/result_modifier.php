...
if (CModule::IncludeModule("socialnetwork"))
{
	...
	if (method_exists('CSocNetLogDestination','GetDestinationSort'))
	{
		$arParams["DESTINATION"] = array(
			...
			"SELECTED" => array(
				"USERS" => array_keys($arResult["QUEUE"])
			)
		);
		CSocNetLogDestination::fillLastDestination($arParams["DESTINATION"]['DEST_SORT'], $arParams["DESTINATION"]['LAST']);
	}
	else
	{
	    $arParams["DESTINATION"] = array(
	...
	else
	{
		...
		if (isset($arParams["DESTINATION"]['LAST']['USERS']))
		{
