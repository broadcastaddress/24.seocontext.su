						...
						if (CModule::IncludeModule("bitrix24")):
							?><a id="logo_24_a" href="<?=SITE_DIR?>" title="<?=GetMessage("BITRIX24_LOGO_TOOLTIP")?>" class="logo"><?
								...
								<span id="logo_24_text" <?if ($clientLogo):?>style="display:none"<?endif?>>
									<span class="logo-text"><?=htmlspecialcharsbx(COption::GetOptionString("bitrix24", "site_title", GetMessage('BITRIX24_SITE_TITLE_DEFAULT')))?></span><?
...
?>
						...
						<?endif?>
						<?
						//We get counters from Messenger and show them in the left menu.
