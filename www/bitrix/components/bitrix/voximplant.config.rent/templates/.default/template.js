...
BX.VoxImplant.rentPhone.drawNumberBox = function()
{
	...
	if (BX.VoxImplant.rentPhone.currentCountry == 'RU')
	{
		...
		{
			specialHeaderText = BX.message('VI_CONFIG_RENT_RU_TOLLFREE');
		...
		{
			specialHeaderText = BX.message('VI_CONFIG_RENT_RU_TOLLFREE804');
	...
	{
		specialHeaderText = BX.message('VI_CONFIG_RENT_TEXT_TOLLFREE');
