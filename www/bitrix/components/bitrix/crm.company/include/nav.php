...
if (!isset($arResult['INTERNAL']) || !$arResult['INTERNAL'])
{
	...
	$copmanyNavTitleListMessageID = 'CRM_COMPANY_NAV_TITLE_LIST';
	if (isset($arResult['MYCOMPANY_MODE']) && $arResult['MYCOMPANY_MODE'] === 'Y')
		$copmanyNavTitleListMessageID = 'CRM_MYCOMPANY_NAV_TITLE_LIST';
	...
	{
		$APPLICATION->AddChainItem(GetMessage($copmanyNavTitleListMessageID), $arParams['PATH_TO_COMPANY_LIST']);
		...
		$APPLICATION->SetTitle(GetMessage($copmanyNavTitleListMessageID));
}
?>