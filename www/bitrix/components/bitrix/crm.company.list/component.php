...
$arResult['IS_EXTERNAL_FILTER'] = $enableCounterFilter;
...
$arResult['HEADERS'] = array_merge($arResult['HEADERS'], array(
	...
	array('id' => 'IS_MY_COMPANY', 'name' => GetMessage('CRM_COLUMN_IS_MY_COMPANY'), 'sort' => 'is_my_company', 'default' => false, 'editable' => true, 'type' => 'checkbox'),
