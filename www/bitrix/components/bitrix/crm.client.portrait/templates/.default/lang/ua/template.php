...
$MESS["CRM_CLIENT_PORTRAIT_LOAD_CONFIG_HELP"] = "Ви можете задати значення середнього навантаження від клієнта вручну або скористатися автоматичним визначенням цього числа. При автоматичному розраховується середня кількість справ на одну операцію.";
