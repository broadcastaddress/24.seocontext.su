...
class CCrmWebFormEditComponent extends \CBitrixComponent
{
	...
	public function processPost()
	{
		...
		$assignedById = (int) $request->get('ASSIGNED_BY_ID');
		if(!$assignedById)
		{
	...
	{
		$userId = (int) $this->arResult['FORM']['ASSIGNED_BY_ID'];
		$this->arResult['FORM']['ASSIGNED_BY_ID'] = '';
		$this->arResult['FORM']['ASSIGNED_BY_NAME'] = '';
		...
		$this->arResult['FORM']['ASSIGNED_BY_ID'] = $userId;

		// format name
		$this->arResult['FORM']['ASSIGNED_BY_NAME'] = CUser::FormatName(
